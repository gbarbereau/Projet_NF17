...
<?php
	...
	$vSql = 'SELECT M.identifiant,M.denomination,C.nom,C.prenom FROM Marchandise M, Client C, Livraison L WHERE L.num_client=M.num_client AND M.date_arri IS NULL AND C.num_client=M.num_client  ORDER BY nom,prenom';
	...
	<label for="code">Code</label> : <INPUT type="text" name="code" size="50"></code></br>
