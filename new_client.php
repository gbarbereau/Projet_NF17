...
<body>
	...
	//Demande numéro de rue : deuxième partie du formulaire
...
//Première partie du formulaire
		...
		<form method ="post" action = "new_client.php">
			<table>
				<tr><td>Nom:</td><td> <input type="text" name="nom" size="30" maxlength="50"></td></tr>
				<tr><td>Prénom:</td><td> <input type="text" name="prenom" size="30" maxlength="50"></td></tr>
			...
			<tr><td><input type="submit" value="ajouter" name="validation"></td></tr>
			</table>
			</form>
		</body>
		</html>