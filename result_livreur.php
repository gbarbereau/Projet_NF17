...
<center><h1> Informations pour le livreur</h1><br/>
	...
	$query="SELECT Route.Nom,Route.Type,Route.Etat, Marchandise.identifiant, COUNT(Client.num_client) AS nb_client FROM Jonction 
			...
			GROUP BY Habitation.nom_route -- pour afficher le nombre de livraison par route
			";
	...
	echo"<tr><td>$array[Route.Type] $array[Route.Nom]</td><td>$array[Route.Etat]</td>";
	echo"<td><a href='page_route.php?nom=".$array['Route.Nom']."&type=".$array['Route.Type']."'>$array[nb_client]</a></td>";//lien de redirectin en get vers la page client.php
	echo"</tr>";
	}
echo"</table>";
